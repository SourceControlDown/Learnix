...
public interface IEmailSender
{
    ...
    /// </param>
    Task SendAccountDeletedAsync(string toEmail, string firstName, DateTime purgeAfterUtc, string language = "en", CancellationToken ct = default);
    Task SendAccountRecoveredAsync(string toEmail, string firstName, string language = "en", CancellationToken ct = default);
