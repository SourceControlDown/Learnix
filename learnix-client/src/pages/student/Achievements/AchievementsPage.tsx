...
export default function AchievementsPage() {
    ...
    return (
        <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6 sm:py-12">
            ...
            {progress && (
                <section className="mt-6 sm:mt-8 rounded-xl border border-border bg-card p-4 sm:p-6">
                    ...
                    <div className="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                        <div className="flex sm:flex-col items-center sm:items-center justify-between sm:justify-start gap-2 rounded-lg bg-muted/50 p-4 text-left sm:text-center">
            ...
            {/* Earned count */}
            <p className="mt-6 sm:mt-8 text-sm font-medium text-muted-foreground">
                {t('page.earnedCount', { count: data?.unlocked.length ?? 0 })}
            </p>

            {/* Achievement grid */}
            <div className="mt-3 grid grid-cols-2 gap-3 sm:gap-4 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
