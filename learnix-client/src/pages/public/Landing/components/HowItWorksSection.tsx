        ...
        <section className="pt-10 pb-20">
            <div className="mx-auto max-w-7xl px-6">
                ...
                <div className="relative grid gap-12 md:gap-8 md:grid-cols-3">
                    ...
                    {steps.map((step) => (
                        <div key={step.n} className="group relative text-center cursor-default">
                            ...
                            <div className="relative z-10 mx-auto grid h-20 w-20 place-items-center rounded-2xl border border-white/5 bg-card/60 backdrop-blur-xl shadow-lg transition-transform duration-500 group-hover:-translate-y-2 group-hover:shadow-primary/20">
                                <span className="font-heading text-3xl font-extrabold bg-gradient-to-br from-primary to-accent bg-clip-text text-transparent">
                                    {step.n}
                                </span>
                            </div>
